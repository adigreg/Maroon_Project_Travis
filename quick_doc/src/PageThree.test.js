...
test('Page Three Should contain Doctor bio, insurance taken, and go back button', () => {
    ...
    const {getByTestId} = render(<PageThree pagestate={3} settingdoctor={{doc: doctortest,setdoc: setdoctest}}/>)
  
    expect(getByTestId("PageThree").textContent).toBe("Terry Anderson")
  })
